return {
    ...
    init = function()
        ...
        nmap('<leader>xw', cmd 'TroubleToggle workspace_diagnostics', '[Trouble] Toggle Workspace Diagnostics')
        nmap('<leader>xd', cmd 'TroubleToggle document_diagnostics', '[Trouble] Toggle Document Diagnostics')
        ...
        nmap('<leader>xr', cmd 'TroubleToggle lsp_references', '[Trouble] Toggle LSP References')
    end
}
